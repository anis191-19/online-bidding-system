...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password">
                 ...
                 <?php if(Route::has('login')): ?>
                   <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 dropdown-item">Log in</a>

                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 dropdown-item">Register</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
              ...
              <div class="carousel-item active " data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block  bg-white-100 rounded">
                  ...
                  <div class="d-flex justify-content-center">
                    ...
                    <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="text-white fw-bold nav-link fs-6">JOIN US</a>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\SD_Project\Online_Bidding_System\resources\views/welcome.blade.php ENDPATH**/ ?>