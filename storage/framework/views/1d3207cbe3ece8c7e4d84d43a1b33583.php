...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 p-5">
            <div class="card">
                <div class="h-50 ">
                    <img src="<?php echo e(asset('images/' . $product->image)); ?>" class="card-img-top h-50 w-50" alt="<?php echo e($product->name); ?>">
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Online_Bidding_System\resources\views/user/productdetails.blade.php ENDPATH**/ ?>